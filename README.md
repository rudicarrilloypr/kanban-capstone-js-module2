...
**Pokemon App** Capstone web application based on Pokemon API.
...
[Click here](https://gleeful-kitsune-465a87.netlify.app/) to see the project's deployment on GitHub pages.
...
```sh
  git clone git@github.com:rudicarrilloypr/kanban-capstone-js-module2.git
```
